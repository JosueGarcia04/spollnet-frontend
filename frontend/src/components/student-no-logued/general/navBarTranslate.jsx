...
.goog-te-menu-value {
  ...
  const replaceLanguageLabels = () => {
    const intervalId = setInterval(() => {
      ...
      if (button) {
        button.textContent = 'Idiomas'; // Cambia el texto aquí
        button.style.padding = '0 10px'; // Ajusta el padding horizontalmente
        clearInterval(intervalId); // Detén el intervalo una vez que se haya encontrado el botón
      }
    }, 100); // Reintenta cada 100ms hasta que el botón esté disponible
