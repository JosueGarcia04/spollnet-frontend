...
export default function InicioIndex() {
    return (
        <div className="flex flex-col  border-b-white lg:flex-row justify-center mt-14 lg:mt-0 px-4 lg:px-10">
            <div className="text-white lg:text-left ">
                <div className="flex flex-col  mt-36 md:mt-44 lg:mt-52 lg:items-start">
                    <div className="flex justify-center md:ml-4 ml-0 mr-32 md:mr-32 lg:mr-0 ">
                        <h1 className="text-3xl md:text-3xl lg:text-4xl lg:mb-2 mb-0">
                            ...
                            <div className="rotating-words font-semibold">
                                <p className="inline-block bg-clip-text text-transparent bg-gradient-to-r from-[#e7148c] to-[#6e1d5c]">Alumnos</p>
                                <p className="inline-block bg-clip-text text-transparent bg-gradient-to-r from-[#e7148c] to-[#6e1d5c]">Maestros</p>
                                <p className="inline-block bg-clip-text text-transparent bg-gradient-to-r from-[#e7148c] to-[#6e1d5c]">SpollNet</p>
                            </div>
                        </h1>
                    </div>
                    <div className="text-3xl md:text-3xl  lg:text-6xl lg:mb-2 mt-4 font-bold text-center lg:text-left px-3.5">
                        <p>Tu voto es fundamental para todos</p>
                    </div>
                    <div className="part2 mb-5">
                        <p className="text-sm lg:text-left md:text-lg text-center font-normal lg:text-lg mt-5 mb-0 lg:pr-14 lg:pl-3.5 pl-3.5 leading-loose">
