export default function Welcome() {
  return (
    <div className="bg-black py-8 flex flex-col items-center justify-center min-screen">
      <h2 className="mb-4 text-center text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold 
                    text-transparent bg-clip-text bg-gradient-to-r from-[#E31FAE] to-[#E4A0D1] 
                    shadow-lg">
        Bienvenidos a Spollnet
      </h2>
      <div className="flex flex-col md:flex-row items-center justify-center max-w-3xl mx-4 p-6 bg-black rounded-xl shadow-xl border-4 border-[#E31FAE]">
