...
import { faHome, faVoteYea, faBell, faNewspaper, faPeopleGroup, faChartBar, faChalkboard } from '@fortawesome/free-solid-svg-icons'
...
const Navdown = () => {
  ...
  return (
   ...
   <nav className={`fixed bottom-0 left-0 right-0 border-2 border-[#e7148c] bg-black py-2 flex justify-around items-center md:hidden rounded-t-3xl transition-all duration-500 ${isAtBottom && isScrolled ? 'rounded-t-none' : ''}`} style={{position: '-webkit-sticky', position: 'sticky', zIndex: 40}}>
      ...
      <Link to="/vote" className="text-white hover:text-gray-400">
        <div className="flex items-center">
          <div className="w-12 h-12 flex justify-center items-center">
            <FontAwesomeIcon icon={faVoteYea} className="w-6 h-6 text-white" />
          </div>
        </div>
      </Link>
      ...
      <Link to="/informacion" className="text-white hover:text-gray-400">
        <div className="flex items-center">
          <div className="w-12 h-12 flex justify-center items-center">
      ...
      <Link to="/publications" className="text-white hover:text-gray-400">
        <div className="flex items-center">
          <div className="w-12 h-12 flex justify-center items-center">
