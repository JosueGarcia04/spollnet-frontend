...
const SignIn = () => {
    ...
    return (
        <>
            <Navbar />
            <div className="h-screen bg-black bg-cover bg-center flex items-center justify-center mt-10">
    <div className="flex w-full sm:max-w-7xl bg-gray-800 bg-opacity-30 p-5 rounded-lg shadow-lg">
        <div className="w-2/3 bg-gray-800 p-6 rounded-lg shadow-lg border border-white">
            <form onSubmit={handleSubmit} className="p-8 ">
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div className="text-center font-bold relative">
                        <label htmlFor="name" className="block text-[#E41FAE]">Nombre completo</label>
                        <input
                            id='name'
                            name='name'
                            type='text'
        ...
        <div className="w-1/3 flex flex-col justify-center items-center text-center text-white p-8 ml-8">
